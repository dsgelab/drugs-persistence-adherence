...
for (p in phenolist) {
  temp <- get_rg(paste0('/home/ivm/drugs/results/R8_20220112/rg/',p,'.af_0.01.info_0.6.gz.rsid.gz.sumstats.gz_RGS.log'))
  d <- rbind(d,temp)
  
  temp <- get_h2(paste0('/home/ivm/drugs/results/R8_20220112/h2/',p,'.af_0.01.info_0.6.gz.rsid.gz.sumstats.gz_H2.log'))
...
to.keep <- c("ADHD_2017.LDSC.sumstats.gz", "BMI.LDSC.sumstats.gz", "CAD.LDSC.sumstats.gz", "EA.LDSC.sumstats.gz", "IBD.LDSC.sumstats.gz",
             ...
             "GCST90012790_buildGRCh38.tsv.gz.sumstats.gz", "GCST90012791_buildGRCh38.tsv.gz.sumstats.gz",
