...
traj <- fread('drugs/data/R8_statins_summarized.txt')
traj.lt75 <- fread('drugs/data/R8_statins_summarized_lt75.txt')

# keep only individuals and purchases included in adherence calculation
purch <- fread('drugs/data/R8_statins.txt') %>%
...
pdf('/home/ivm/drugs/plots/R8/statins_adherence.pdf', width = 5, height = 6)
plotAdherenceDensity(traj, "Statins")
dev.off()

# plotAdherenceDensity(traj.lt75)

pdf('/home/ivm/drugs/plots/R8/statins_adherence_age.pdf', width = 8, height = 6)
plotAdherenceByAge(traj, "Statins")
dev.off()
...
pdf('/home/ivm/drugs/plots/R8/statins_purch_years.pdf', width = 7, height = 5)
...
pdf('/home/ivm/drugs/plots/R8/statins_purch_months.pdf', width = 7, height = 5)
...
pdf('/home/ivm/drugs/plots/R8/statins_purch_avg_months.pdf', width = 7, height = 5)
...
pdf('/home/ivm/drugs/plots/R8/statins_adherence_purchases_per_month.pdf', width = 4, height = 3)
