...
traj <- fread('drugs/data/R8_blood_pressure_summarized.txt')
traj.lt75 <- fread('drugs/data/R8_blood_pressure_summarized_lt75.txt')

# keep only individuals and purchases included in adherence calculation
purch <- fread('drugs/data/R8_blood_pressure.txt') %>%
...
pdf('/home/ivm/drugs/plots/R8/blood_pressure_adherence.pdf', width = 4, height = 6)
plotAdherenceDensity(traj)
dev.off()

# plotAdherenceDensity(traj.lt75)

pdf('/home/ivm/drugs/plots/R8/blood_pressure_adherence_age.pdf', width = 8, height = 6)
...
pdf('/home/ivm/drugs/plots/R8/blood_pressure_purch_years.pdf', width = 7, height = 5)
...
pdf('/home/ivm/drugs/plots/R8/blood_pressure_purch_months.pdf', width = 7, height = 5)
...
pdf('/home/ivm/drugs/plots/R8/blood_pressure_purch_avg_months.pdf', width = 7, height = 5)
...
pdf('/home/ivm/drugs/plots/R8/blood_pressure_adherence_purchases_per_month.pdf', width = 4, height = 3)
