...
ep <- fread('/home/cordioli/mount_fg/finngen_R7_endpoint.txt.gz')
system("fusermount -u /home/cordioli/mount_fg")

#TODO: have everything running managing memory properly
...
fwrite(st, '/home/cordioli/drugs/data/R7_statins_gap_150.txt', sep = '\t', quote = F)
...
fwrite(stt, '/home/cordioli/drugs/data/R7_statins_summarized_150.txt', sep = '\t', quote = F)

# Truncate follow up at 75y
st.lt75 <- fread('/home/cordioli/drugs/data/R7_statins_gap_150.txt') %>% 
  filter(EVENT_AGE <= 75)
stt.lt75 <- summarizeTrajectories(st.lt75)
...
fwrite(stt.lt75, '/home/cordioli/drugs/data/R7_statins_summarized_150_lt75.txt', sep = '\t', quote = F)
...
if (write.flag == T) {
  fwrite(bp, '/home/cordioli/drugs/data/R7_bp_gap_150.txt', sep = '\t', quote = F)
}
...
if (write.flag == T) {
  fwrite(bpp, '/home/cordioli/drugs/data/R7_bp_summarized_150.txt', sep = '\t', quote = F)
}
...
if (write.flag == T) {
  fwrite(cd, '/home/cordioli/drugs/data/R7_clopi_dipy_gap_150.txt', sep = '\t', quote = F)
}
...
if (write.flag == T) {
  fwrite(ccdd, '/home/cordioli/drugs/data/R7_clopi_dipy_summarized_150.txt', sep = '\t', quote = F)
}
...
if (write.flag == T) {
  fwrite(bc, '/home/cordioli/drugs/data/R7_breast_cancer_gap_150.txt', sep = '\t', quote = F)
}
...
if (write.flag == T) {
  fwrite(bcc, '/home/cordioli/drugs/data/R7_breast_cancer_summarized_150.txt', sep = '\t', quote = F)
}
...
if (write.flag == T) {
  fwrite(do, '/home/cordioli/drugs/data/R7_doac_gap_150.txt', sep = '\t', quote = F)
}
...
if (write.flag == T) {
  fwrite(doo, '/home/cordioli/drugs/data/R7_doac_summarized_150.txt', sep = '\t', quote = F)
}
...
fwrite(gl, '/home/cordioli/drugs/data/R7_glaucoma_all_pkoko_ok.txt', sep = '\t', quote = F)
...
# Complete trajectories
g <- fread('/home/cordioli/drugs/data/R7_glaucoma_all_pkoko_ok.txt')
...
if (write.flag == T) {
  fwrite(gl, '/home/cordioli/drugs/data/R7_glauc_gap_150.txt', sep = '\t', quote = F)
}

if (write.flag == T) {
  fwrite(gll, '/home/cordioli/drugs/data/R7_glauc_summarized_150.txt', sep = '\t', quote = F)
}
