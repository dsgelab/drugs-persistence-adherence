...
traj <- fread('/home/cordioli/drugs/data/R7_statins_summarized_150.txt')
traj.lt75 <- fread('/home/cordioli/drugs/data/R7_statins_summarized_150_lt75.txt')

# keep only individuls and purchases included in adherence calculation
purch <- fread('/home/cordioli/drugs/data/R7_statins_gap_150.txt') %>%
...
pdf('/home/cordioli/drugs/plots/R7/statins_purch_years.pdf', width = 7, height = 5)
ggplot(data=purch_year, aes(x=yy, y=Freq)) +
  geom_bar(stat="identity", fill = "dodgerblue3") +
  theme_minimal()
dev.off()

pdf('/home/cordioli/drugs/plots/R7/statins_purch_months.pdf', width = 7, height = 5)
...
pdf('/home/cordioli/drugs/plots/R7/statins_purch_avg_months.pdf', width = 7, height = 5)
...
pdf('/home/cordioli/drugs/plots/R7/statins_adherence_purchases_per_month.pdf', width = 4, height = 3)
