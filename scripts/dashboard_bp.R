...
traj <- fread('/home/cordioli/drugs/data/R7_bp_summarized_150.txt')

# keep only individuls and purchases included in adherence calculation
purch <- fread('/home/cordioli/drugs/data/R7_bp_gap_150.txt') %>%
...
save(list = "ATCs", file = 'drugs/data/R7_BP_ATCs')
...
pdf('/home/cordioli/drugs/plots/R7/bp_purch_years.pdf', width = 7, height = 5)
...
pdf('/home/cordioli/drugs/plots/R7/bp_purch_months.pdf', width = 7, height = 5)
...
pdf('/home/cordioli/drugs/plots/R7/bp_purch_avg_months.pdf', width = 7, height = 5)
...
pdf('/home/cordioli/drugs/plots/R7/bp_adherence_month_avg_across_ind.pdf', width = 7, height = 5)
...
pdf('/home/cordioli/drugs/plots/R7/bp_adherence_month_avg_per_ind.pdf', width = 7, height = 5)
ggplot(data=adh_avg_month, aes(x=month, y=avg_adh_month)) +
  geom_line(aes(group = 1)) +
  geom_point() +
  theme_minimal()
...
pdf('/home/cordioli/drugs/plots/R7/bp_adherence_purchases_per_month.pdf', width = 4, height = 3)
